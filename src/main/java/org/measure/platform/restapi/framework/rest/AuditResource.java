...
public class AuditResource {
     ...
     * @throws java.net.URISyntaxException if there is an error to generate the pagination HTTP headers
     */
    @GetMapping
    ...
    public ResponseEntity<List<AuditEvent>> getByDates(@RequestParam(value = "fromDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate fromDate, @RequestParam(value = "toDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate toDate, Pageable pageable) throws URISyntaxException {
